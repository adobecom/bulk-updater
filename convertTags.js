import caasTags from './caas-tags.js';

const tagMap = {
    'adobe-com-enterprise:business-size/enterprise': 'caas:audience/enterprise',
    ...
    'adobe-com-enterprise:product/adobe-experience-manager-guides':
      'caas:products/adobe-experience-manager-guides',
    ...
    'adobe-com-enterprise:product/creative-cloud-enterprise':
      'caas:products/creative-cloud-for-enterprise',
    'adobe-com-enterprise:product/customer-journey-analytics':
      'caas:products/customer-journey-analytics',
    ...
    'adobe-com-enterprise:product/experience-manager-assets':
      'caas:products/adobe-experience-manager-assets',
    'adobe-com-enterprise:product/experience-manager-forms':
      'caas:products/adobe-experience-manager-forms',
    'adobe-com-enterprise:product/experience-manager-sites':
      'caas:products/adobe-experience-manager-sites',
    ...
    'adobe-com-enterprise:product/real-time-customer-data-platform':
...
const convertTags = (cqtags) =>
  cqtags && cqtags
    .split(',')
    .map((t) => {
      const tag = t.trim();
      if (tagMap[tag]) return tagMap[tag];
      if (caasTags.includes(tag.split(':')[1])) {
        return `caas:${tag.split(':')[1]}`;
      }
      return null;
    })
    .filter((tag) => tag !== null)
